...
>
> Вносить изменения в файлы — можно. Коммитить и пушить — нельзя никогда.
> Если пользователь просит сделать пуш — отказаться и попросить его сделать самостоятельно.

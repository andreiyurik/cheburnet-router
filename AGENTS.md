...
> [!warning] V1 ЗАМОРОЖЕН
> Этот файл описывает **v1** (podkop/sing-box, 11 setup-скриптов) — слой заморожен в рамках
> strangler-fig-миграции на v2. В v1 допускаются **только фиксы стабильности** для работающих
> установок; новые фичи — только в v2 (`engine/` + `web-v2/`, гид — [CLAUDE.md](./CLAUDE.md)).
> План вывода v1 из эксплуатации — [docs/architecture-v2.md](docs/architecture-v2.md),
> раздел «Sunset v1».

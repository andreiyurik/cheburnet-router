...
Роутер **автоматически** разделяет трафик: локальные сайты, банки и государственные сервисы — напрямую, на полной скорости, без сбоев; зарубежные ресурсы — через зашифрованный туннель; реклама не загружается. На телефоне, на Smart TV, на консоли. **Роутер настроен и делает всё сам — тебе ничего переключать не нужно.**

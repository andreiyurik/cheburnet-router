...
Я делаю всё один: пишу код, держу документацию актуальной, отвечаю в Telegram, разбираю баги у конкретных пользователей. Это много часов, которые я не трачу на основную работу. **Любая поддержка — сигнал, что проект нужен, и мотивация продолжать каждый день.**

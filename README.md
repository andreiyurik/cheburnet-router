...
Подключился к Wi-Fi → реклама не загружается, трафик зашифрован, локальные сайты летают на полной скорости. На телефоне, на Smart TV, на консоли. Без приложений, без кнопок, без настроек на устройствах.
...
> 🎯 **Ключевая фишка: умный автоматический split-routing**
>
> Локальные сайты, банки и государственные сервисы — напрямую, на полной скорости, без сбоев.  
> Зарубежные ресурсы — автоматически через зашифрованный туннель.  
> **Роутер сам решает, куда отправить каждый запрос. Тебе ничего переключать не нужно.**
...
> Если денег нет — это тоже помогает: поставь ⭐, расскажи друзьям, пришли PR или баг-репорт. Спасибо. 🙏

...
Роутер **АВТОМАТИЧЕСКИ** разделяет трафик: локальные сайты, банки и государственные сервисы — напрямую, на полной скорости, без сбоев; зарубежные ресурсы — через зашифрованный туннель; реклама не загружается. 

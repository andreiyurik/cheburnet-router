...
# Обновлено 2026-07-30 (сверено с sha256sums; qemu-v2 + qemu-install-v2 зелёные на этом образе).
: "${IMG_SHA256:=580a0cd320fe23c66963b4f2264878de27e28fd364f487f380295634507f2e0c}"
: "${SSH_PORT:=2222}"

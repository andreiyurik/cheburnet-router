#!/bin/bash
# tests/qemu/live-install-v2.sh — T4b: УСПЕШНАЯ установка целиком + перезагрузка поверх неё.
#
# Зачем. T3g (rollback-v2) доказал, что мёртвый сервер не выдаётся за успех. Но обратная,

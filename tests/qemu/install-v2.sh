...
vm_ssh 'uci get dhcp.@dnsmasq[0].nftset 2>/dev/null | grep -q "example.com/4#inet#fw4#direct"' \
    || { echo "  ✗ nftset-привязка не записана в uci"; vm_ssh 'uci get dhcp.@dnsmasq[0].nftset'; exit 1; }
...
echo "  ✓ dnsmasq-full принял nftset и работает"

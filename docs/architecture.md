...
> QEMU-тесты); v1 удалён по чек-листу [Sunset v1](kb/meta/sunset-v1.md). Мотивация решений —
...
отвергнуты — почему, см. [reliability.md](kb/architecture/reliability.md)), а три
...
[Sunset v1](kb/meta/sunset-v1.md); больше нигде старая архитектура не описывается.
...
Осталось до широкого релиза: подписанный feed (+kmod-amneziawg под поддерживаемые target'ы).

...
> только туннель awg0 на sing-box/`singtun0` — data-plane вокруг тот же, и это верно для ОБОИХ
> Full-протоколов: [[vless-reality]] и [[hysteria2]] делят один интерфейс, поэтому пометка,
> policy-routing и kill-switch не знают, какой из них активен.)
